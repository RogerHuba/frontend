...
export function AdventureGuidesPage() {
  ...
  const classicDungeons: Guide[] = [
    ...
    },
    {
      ...
      content: "The Geonosian Bio-Lab on Yavin 4 is a dangerous research facility where Separatist scientists conducted horrific experiments. Players must navigate through infected corridors, battle mutated creatures, and uncover the dark secrets hidden within the facility's depths."
    },
    {
  ...
  const jediQuests: Guide[] = [
    ...
    },
    {
      ...
      guideLink: "/guides/the-knight-trials"
    }
  ];
  ...
  const preparation: Guide[] = [
    ...
    },
    {
      ...
      content: "Master the art of treasure hunting across the galaxy's many worlds. Learn about waypoint systems, treasure maps, and the valuable rewards that await dedicated treasure hunters.",
      guideLink: "/guides/treasure-hunting"
    }
  ];
